          ...
          <div className="col-xl-9 col-sm-12">
            <div className="tp-about-4-wrapper" style={{ color: '#fff', }}>
              ...
              <p
                ...
                data-wow-delay=".5s"
              >
                With a focus on innovation and efficiency, we tailor our
                services to meet the specific needs and challenges of each
                client, ensuring seamless integration and maximum impact.
              </p>
              <div
